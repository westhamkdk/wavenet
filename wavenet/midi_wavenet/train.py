...
def get_arguments():
    ...
    parser.add_argument('--batch_size', type=int, default=BATCH_SIZE,
                        help='How many midi files to process at once.')
    ...
    parser.add_argument('--sample_size', type=int, default=SAMPLE_SIZE,
                        help='Concatenate and cut midi samples to this many '
                        'samples.')
...
def main():
    ...
    loss = net.loss(midi_batch, args.l2_regularization_strength)
    ...
    try:
        ...
        for step in range(saved_global_step + 1, args.num_steps):
            if step % CONSOLE_OUTPUT_EVERY == 0:
...
if __name__ == '__main__':
    ...
    main()
    print("Finish training at {}".format(datetime.now()))
