...
def load_generic_midi(directory, encoding='time_single'):
...
class MidiReader(object):
    ...
    def thread_main(self, sess):
        ...
        while not stop:
            iterator = load_generic_midi(self.midi_dir)
...
if __name__ == "__main__":
    ...
    reader = MidiReader(midi_dir, coord, sample_size=None, queue_size=4)
